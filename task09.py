...
# Kara sucht Erdbeeren. Sie weiß, dass welche geradeaus vor ihr liegen - sie muss nur um die Bäume herumlaufen. Glücklicherweise stehen diese immer einzeln. Schreibe ein Programm, das sie bis zur Erdbeere führt!
